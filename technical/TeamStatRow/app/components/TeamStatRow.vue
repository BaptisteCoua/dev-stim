   ...
   <div class="d-flex flex-column ga-3">
      <div class="d-flex align-center justify-space-between">
         <span class="font-weight-medium">
            {{ label }}
            <span v-if="labelPercentage !== undefined"> {{ labelPercentage }}% </span>
         </span>
         <v-chip v-if="variant === 'badge'" :color="color" class="px-5 py-1 font-weight-semibold">
            <v-icon v-if="trend" :icon="trendIcon" size="x-small" class="mr-1" />
            {{ value }}
         </v-chip>
