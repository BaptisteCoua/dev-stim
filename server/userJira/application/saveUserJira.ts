...
import { toPersistedUserJiraDto, toDomainUserJira } from '~/server/userJira/interface/userJiraMapper'
import { userJiraRepository } from '~/server/userJira/infrastructure/userJiraRepository'

export async function saveUserJira(data: UserJiraDto): Promise<{ data: ReturnType<typeof toPersistedUserJiraDto>; created: boolean }> {
